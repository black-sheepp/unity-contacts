          ...
          <div className='flex flex-col mt-6 '>
               ...
               <div className='flex justify-center mb-1'>
                    <div className='bg-[#fefae0] w-1/2 justify-between flex px-5 py-3 rounded-xl'>
                         <p className='text-lg text-[#0a1128] font-bold w-1/4'>Shivam Kumar Gupta</p>
                         <p className='text-lg text-[#0a1128] w-1/5'>9845888500</p>
                         <p className=' text-[#0a1128] w-1/4'>shivamguptanitw@gmail.com</p>
               ...
               <div className='flex justify-center mb-1'>
                    <div className='bg-[#fefae0] w-1/2 justify-between flex px-5 py-3 rounded-xl'>
                         <p className='text-lg text-[#0a1128] font-bold w-1/4'>Shivam Gupta</p>
                         <p className='text-lg text-[#0a1128] w-1/5'>9845888500</p>
                         <p className=' text-[#0a1128] w-1/4'>shivamguptanitw@gmail.com</p>
                         <div className='flex justify-between'>
                              <FontAwesomeIcon
